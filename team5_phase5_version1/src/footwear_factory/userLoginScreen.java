...
public class userLoginScreen extends javax.swing.JFrame {
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        if (username.equalsIgnoreCase("1010") && password.equalsIgnoreCase("1010")) {
            Footwear_Factory globalInstance = Footwear_Factory.getInstance();
                        globalInstance.setCurrentUserID(Integer.parseInt("1010"));
            userMainScreen amS = new userMainScreen();
            amS.setVisible(true);
            this.setVisible(false);
        } else if (username.equalsIgnoreCase("1011") && password.equalsIgnoreCase("1011")) {
            Footwear_Factory globalInstance = Footwear_Factory.getInstance();
                        globalInstance.setCurrentUserID(Integer.parseInt("1011"));
            userMainScreen amS = new userMainScreen();
            amS.setVisible(true);
            this.setVisible(false);
        } else if (username.equalsIgnoreCase("1012") && password.equalsIgnoreCase("1012")) {
            Footwear_Factory globalInstance = Footwear_Factory.getInstance();
                        globalInstance.setCurrentUserID(Integer.parseInt("1012"));
            userMainScreen amS = new userMainScreen();
            amS.setVisible(true);
            this.setVisible(false);
